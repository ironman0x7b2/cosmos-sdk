...
func (msc MsgDeleteVpnUser) Route() string {
	return "sentinel"
}
...
func (msc MsgSigntoVpn) Route() string {
	return "sentinel"
}
...
func (msc MsgGetVpnPayment) Route() string {
	return "sentinel"
}

func (msc MsgGetVpnPayment) Type() string {
	return "getvpnpayment"
}
...
func (msc MsgSendTokens) Route() string {
	return "sentinel"
}
